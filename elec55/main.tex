...
\end{center}
    ...
    \end{itemize}  
      In reality, as we can see from the image above, because the system is the status of delay for most of its functioning time, we can see LED 7 is always on, and LED 6 is glimmering. Which means the system spent most of its time in delaying(Status 10).
