...
\captionof{figure}{This is the system response when $k_1=0.36$ and $k_3=0.1418$. As we can see, this system response roughly satisfied our two basic requirement.}
}
\end{minipage}
\medskip
