...
widget.SetInput(pl3d.GetOutput())
widget.PlaceWidget()
widget.SetPoint1(15, -5, 32)
widget.SetPoint2(15,  5, 32)
widget.SetResolution(21)
widget.ClampToBoundsOn()
widget.GetLineProperty().SetColor(1,0,0)
...
def Streamlines(obj, event):
    global seeds, renWin
    obj.GetPolyData(seeds)
    renWin.Render()

widget.SetInteractor(iren)
widget.AddObserver("StartInteractionEvent", Start)
widget.AddObserver("InteractionEvent", Streamlines)
